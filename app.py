...
with st.sidebar:
    ...
    page = st.radio("Navigate", ["Prospects", "Pitches", "Activation", "Contracts Q&A", "Partner Dashboard"], index=0)

    # Optional: keep a *safe* settings area (no secrets shown)
...
# ------------------------
with st.sidebar:
    if 'HEADER_LOGO' in globals() and HEADER_LOGO.exists():
        st.image(str(HEADER_LOGO), width=96)
